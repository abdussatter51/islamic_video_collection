...
public class ArabicSongActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private void addVideos(){
        ...
        //Video No-01 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "5azDyOkmjp8");
        hashMap.put("vdo_title", "Amantu Billahi - Official NO MUSIC Version");
        hashMap.put("vdo_desciption", "Singer: Ayisha Abdul Basith");
        arrayList.add(hashMap);

        //Video No-01 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "E5ptoktjNto");
        hashMap.put("vdo_title", "Sholawat Merdu");
        hashMap.put("vdo_desciption", "Singer: Ayisha Abdul Basith");
        arrayList.add(hashMap);

        //Video No-01 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "CZ9LkTyZOxM");
        hashMap.put("vdo_title", "Tala al badru alayna|Vocal|with English translation");
        hashMap.put("vdo_desciption", "Singer: Arabic Gajal");
        arrayList.add(hashMap);

        //Video No-01 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "5XxnLpE7ObQ");
        hashMap.put("vdo_title", "Beautiful Arabic Islamic Marriage song");
        hashMap.put("vdo_desciption", "Singer: AHT Habib");
        arrayList.add(hashMap);

        //Video No-01 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "IAf6GOnPpnE");
        hashMap.put("vdo_title", "The Most Beautiful Islamic Arabic Nasheed (Mashup)");
        hashMap.put("vdo_desciption", "Singer: Music Upscale");
        arrayList.add(hashMap);

        //Video No-01 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "DObcUOFLsGI");
        hashMap.put("vdo_title", "Ya Taiba | Ayisha Abdul Basith");
        hashMap.put("vdo_desciption", "Singer: Ayisha Abdul Basith");
        arrayList.add(hashMap);
        ...
        hashMap.put("vdo_title", "Burdah Maula ya Salli Official video");
        hashMap.put("vdo_desciption", "Singer: Mesut Kurtis");
        arrayList.add(hashMap);

        //Video No-01 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "VKXhwu3OAPI");
        hashMap.put("vdo_title", "ALLAHU EXCLUSIVE NASHEED");
        hashMap.put("vdo_desciption", "Singer: Ahmadullah");
        arrayList.add(hashMap);

        //Video No-01 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "pPuvcfiwnns");
        hashMap.put("vdo_title", "Oh My Soul ll Beautiful Arabic Nasheed 2021");
        hashMap.put("vdo_desciption", "Singer: Motivation Video");
        arrayList.add(hashMap);

        //Video No-01 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "Vqfy4ScRXFQ");
        hashMap.put("vdo_title", "Ya Nabi Salam Alayka (Arabic) | ماهر زين - يا نبي سلام عليك");
        ...
        hashMap.put("vdo_title", "Madad (Nasimi Arabic Version)");
        hashMap.put("vdo_desciption", "Singer: Sami Yusuf");
        arrayList.add(hashMap);

        //Video No-01 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "FWwwZ8qSM3U");
        hashMap.put("vdo_title", "99 Names of Allah (swt) nasheed by Omar Esa");
        hashMap.put("vdo_desciption", "Singer: Omar Esaf");
        arrayList.add(hashMap);

        //Video No-01 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "SZ-rMHOPyHk");
        hashMap.put("vdo_title", "Mo Vocals - Muhammad Nabina (2021) | Official Nasheed Video");
        hashMap.put("vdo_desciption", "Singer: Muhammad");
        arrayList.add(hashMap);

        //Video No-01 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "nydmOuQXpQk");
        hashMap.put("vdo_title", "Mo Vocals - Qamarun قَمَرٌ [Official Nasheed Video] 4K");
        hashMap.put("vdo_desciption", "Singer: Muhammad");
        arrayList.add(hashMap);

        //Video No-01 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "7P7LVWW3hkw");
        hashMap.put("vdo_title", "Mo Vocals - Maula Ya Salli 2021 (NO MUSIC)");
        hashMap.put("vdo_desciption", "Singer: Muhammad");
        arrayList.add(hashMap);
        ...
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "SZ-rMHOPyHk");
        hashMap.put("vdo_title", "Mo Vocals - Muhammad Nabina (2021)");
        hashMap.put("vdo_desciption", "Singer: Muhammad");
        arrayList.add(hashMap);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        youTubePlayerView.initialize("ABCD", ArabicSongActivity.this);
            ...
            public void onClick(View v) {
                ...
                if (v!=null && v.getTag()!=null){
                    ...
                    if (tag.contains("PLAYING")){
                        ...
                        else Toast.makeText(ArabicSongActivity.this, "Please wait...", Toast.LENGTH_LONG).show();
    ...
    private void makeListView(){
        ...
        ListView listView = new ListView( ArabicSongActivity.this);
        ...
        layoutContainer.startAnimation(AnimationUtils.loadAnimation(ArabicSongActivity.this, R.anim.fade_in));
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public MyAdapter(){
            this.inflater = (LayoutInflater) ArabicSongActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        }
    ...
    private void playVideo(String video_id){
        ...
        if(myYoutubePlayer!=null){
            ...
            layPlayer.startAnimation(AnimationUtils.loadAnimation(ArabicSongActivity.this, R.anim.fade_in));
            myYoutubePlayer.loadVideo(video_id);
            myYoutubePlayer.play();
            playingVideo = true;
        }else{
            Toast.makeText(ArabicSongActivity.this, "Please wait...", Toast.LENGTH_LONG).show();
        }
    }
    //================================================
    ...
    private void playPreviousVideo(){
        if(PLAYING_NOW > 0){
            ...
            Toast.makeText(ArabicSongActivity.this, "Playing the first video", Toast.LENGTH_LONG).show();
        }
